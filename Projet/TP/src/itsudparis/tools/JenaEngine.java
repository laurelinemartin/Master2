...
public class JenaEngine {
	static private String RDF = "http://www.w3.org/1999/02/22-rdfsyntax-ns#";
/**
...
*/
	static public Model readInferencedModelFromRuleFile(Model model, String i) {
		InputStream in = FileManager.get().open(i);
		if (in == null) {
			System.out.println("Rule File: " + i + " not found");
			return null;
		} else {
			try {
				in.close();
...
// TODO Auto-generated catch block
		...
		List<Rule> rules = Rule.rulesFromURL(i);
